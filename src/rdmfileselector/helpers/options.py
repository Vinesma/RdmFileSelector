...
class Options:
    ...
    def __init__(self):
        ...
        parser.add_argument(
            ...
            "--quantity",
            type=int,
            help="how many files to pick from the input directory.",
        )
        parser.add_argument("-i", "--input", help="where to select the files from.")
        parser.add_argument(
            "-v",
            "--verbose",
            help="make the application more verbose.",
            action="store_true",
        )
        parser.add_argument(
            "-c", "--cache", help="use a different directory for the cache file."
        )
        parser.add_argument(
            "-o",
            "--condition",
        ...
        # positional
        parser.add_argument(
            "destination", help="where to put the randomly picked files."
        )
